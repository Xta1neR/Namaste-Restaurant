...
const Hero = () => {
  return (
    <div>
      ...
      {/* ------------------- Sharing Plates ---------------- */}
      <section className="bg-[#110c09] text-white flex flex-col items-center px-4 py-10">
        <h1 className="text-4xl font-extrabold mb-3">Sharning Plates</h1>
        <div className="flex items-center gap-3 mb-14">
          <div className="border-t border-[#d99e5f] w-24"></div>
          <span className="text-[#d99e5f] text-2xl">
            <FontAwesomeIcon icon={faBowlFood} />
          ...
          <div className="space-y-10">
            <div>
              <div className="space-y-6">
                <div>
                  <div className="flex justify-between border-b border-[#d99e5f] pb-1">
                    <h3 className="font-semibold text-white">Chicken Bite with Fries</h3>
                    <span className="font-semibold text-white">$10.95</span>
                  </div>
                  <p className="text-[#d99e5f] text-xs mt-1">
                    {/* Traditional fried basa fish coated in chickpea our, rice our
                ...
                <div>
                  <div className="flex justify-between border-b border-[#d99e5f] pb-1">
                    <h3 className="font-semibold text-white">Fish & Chips 1pcs/2pcs</h3>
                    <span className="font-semibold text-white">$11.95 / $15.95</span>
                  </div>
                  <p className="text-[#d99e5f] text-xs mt-1">
                  2 pieces of crispy battered cod served with fries and tartar sauce
                  </p>
                </div>
            ...
            <div>
              <div className="space-y-6">
                <div>
                  ...
                  <p className="text-[#d99e5f] text-xs mt-1">
                  Naan bread stuffed with chopped spinach, cheese & grated Indian cheese.
                  </p>
                </div>
                <div>
                  <div className="flex justify-between border-b border-[#d99e5f] pb-1">
            ...
            <div>
              <div className="space-y-6">
                <div>
                  ...
                  <p className="text-[#d99e5f] text-xs mt-1">
                  Boneless chickenpieces marinated with garlic & exotic Indian spices. Cooked in our Indian clay oven & served with mint chutney. Served on rice.
                  </p>
                </div>
                <div>
                  <div className="flex justify-between border-b border-[#d99e5f] pb-1">
                    <h3 className="font-semibold text-white">Saffron Chicken Tikka</h3>
                    <span className="font-semibold text-white">$18.95</span>
                  </div>
                  <p className="text-[#d99e5f] text-xs mt-1">
                  Boneless chickenpieces marinated with cream cheese, saffron & exotic Indian spices. Cooked in our Indian clay oven & served with mint chutney. Served on rice.
                  </p>
                </div>
                <div>
                  <div className="flex justify-between border-b border-[#d99e5f] pb-1">
                  ...
                  <p className="text-[#d99e5f] text-xs mt-1">
                  Boneless chicken pieces marinated with fresh mint, cilantro & exotic Indian spices. Cooked in our Indian clay oven & served with mint chutney. Served on rice.</p>
                </div>
                <div>
                  <div className="flex justify-between border-b border-[#d99e5f] pb-1">
                    <h3 className="font-semibold text-white">Tandoori Chicken 4pcs/8pcs</h3>
                    <span className="font-semibold text-white">$15.95/$22.95
                    </span>
                  </div>
                  <p className="text-[#d99e5f] text-xs mt-1">
          ...
          <div className="space-y-10">
            <div>
              <div className="space-y-6">
                <div>
                  <div className="flex justify-between border-b border-[#d99e5f] pb-1">
                    <h3 className="font-semibold text-white">Kasturi Shashlic Paneer Tikka</h3>
                ...
                <div>
                  <div className="flex justify-between border-b border-[#d99e5f] pb-1">
                    <h3 className="font-semibold text-white">Tandoori Fish Tikka</h3>
                    <span className="font-semibold text-white">$18.95</span>
                  </div>
                  <p className="text-[#d99e5f] text-xs mt-1">
                  Basa fish marinated with ginger, garlicand exotic Indian spices. Cooked in our Indian clay oven & served with mint chutney. Served on rice.
                  </p>
                </div>
                <div>
                  <div className="flex justify-between border-b border-[#d99e5f] pb-1">
                    <h3 className="font-semibold text-white">Tandoori Prawns Tikka</h3>
                    <span className="font-semibold text-white">$19.95</span>
                  </div>
                  <p className="text-[#d99e5f] text-xs mt-1">
          ...
          <div className="space-y-10">
            <div>
              <div className="space-y-6">
                ...
                <div>
                  <div className="flex justify-between border-b border-[#d99e5f] pb-1">
                    <h3 className="font-semibold text-white">Veg Manchurian (Dry/Gravy)</h3>
                    <span className="font-semibold text-white">$16.95</span>
                  </div>
                  <p className="text-[#d99e5f] text-xs mt-1">
                ...
                <div>
                  ...
                  <p className="text-[#d99e5f] text-xs mt-1">
                  Boneless chicken pieces cooked sweet and tangy Chinese sauce.
                  </p>
                </div>
                <div>
                  <div className="flex justify-between border-b border-[#d99e5f] pb-1">
                    <h3 className="font-semibold text-white">Chilli Chicken (Dry/Gravy)</h3>
                    <span className="font-semibold text-white">$16.95</span>
                  </div>
                  <p className="text-[#d99e5f] text-xs mt-1">
                  Boneless chicken pieces prepared with onion and bell pepper, blended with Chinese sauce.
                  </p>
                </div>
                <div>
                  <div className="flex justify-between border-b border-[#d99e5f] pb-1">
                    <h3 className="font-semibold text-white">Chilli Paneer (Dry/Gravy)</h3>
                    <span className="font-semibold text-white">$17.95</span>
                  </div>
                  <p className="text-[#d99e5f] text-xs mt-1">
                  Pieces of paneer prepared with onion and bell pepper, blended with Chinese sauce.
                  </p>
                </div>
                <div>
                  <div className="flex justify-between border-b border-[#d99e5f] pb-1">
                  ...
                  <p className="text-[#d99e5f] text-xs mt-1">
                  Prawn prepared with onion and bell pepper, blended with Chinese sauce.{" "}
                  </p>
                </div>
                <div>
                  <div className="flex justify-between border-b border-[#d99e5f] pb-1">
          ...
          <div className="space-y-10">
            <div>
              ...
              <div>
                ...
                <div>
                  <div className="flex justify-between border-b border-[#d99e5f] pb-1">
                    <h3 className="font-semibold text-white">Chicken Chowmien</h3>
                    <span className="font-semibold text-white">$15.95</span>
                  </div>
                  <p className="text-[#d99e5f] text-xs mt-1">
                  Rice noodles stir-fry with chicken, Chinese sauces, and vegetables.{" "}
                  </p>
                </div>
                <div>
                  <div className="flex justify-between border-b border-[#d99e5f] pb-1">
                ...
                <div>
                  <div className="flex justify-between border-b border-[#d99e5f] pb-1">
                    <h3 className="font-semibold text-white">Chicken Fried Rice</h3>
                    <span className="font-semibold text-white">$15.95</span>
                  </div>
                  <p className="text-[#d99e5f] text-xs mt-1">
          ...
          <div className="space-y-10">
            <div>
              <div className="space-y-6">
                ...
                <div>
                  <div className="flex justify-between border-b border-[#d99e5f] pb-1">
                    <h3 className="font-semibold text-white">Vegetable coconut curry</h3>
                    <span className="font-semibold text-white">$15.95</span>
                  </div>
                  <p className="text-[#d99e5f] text-xs mt-1">
            ...
            <div>
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <p className="text-[#d99e5f] text-xs mt-1">
                  Paneer prepared with bell peppers onion & exotic Indian spices with chilli garlic saus.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div>
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <p className="text-[#d99e5f] text-xs mt-1">
                  Boneless pieces of chicken breast delicately cooked in a tomato onion sauce with touch of korma sauceand exotic spices.{" "}
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="space-y-10">
            <div>
              <div className="space-y-6">
                <div>
                  <div className="flex justify-between border-b border-[#d99e5f] pb-1">
                    <h3 className="font-semibold text-white">Chicken vindaloo</h3>
                    <span className="font-semibold text-white">$16.95</span>
                  </div>
                  <p className="text-[#d99e5f] text-xs mt-1">
                ...
                <div>
                  <div className="flex justify-between border-b border-[#d99e5f] pb-1">
                    <h3 className="font-semibold text-white">Chicken Coconut Curry</h3>
                    <span className="font-semibold text-white">$17.95</span>
                  </div>
                  <p className="text-[#d99e5f] text-xs mt-1">
                ...
                <div>
                  <div className="flex justify-between border-b border-[#d99e5f] pb-1">
                    <h3 className="font-semibold text-white">Chicken shahi korma</h3>
                    <span className="font-semibold text-white">$17.95</span>
                  </div>
                  <p className="text-[#d99e5f] text-xs mt-1">
                ...
                <div>
                  <div className="flex justify-between border-b border-[#d99e5f] pb-1">
                    <h3 className="font-semibold text-white">Green chicken curry</h3>
                    <span className="font-semibold text-white">$16.95</span>
                  </div>
                  <p className="text-[#d99e5f] text-xs mt-1">
                ...
                <div>
                  ...
                  <p className="text-[#d99e5f] text-xs mt-1">
                  Boneless Meat cooked with onion, ginger & garlic gravy, royal spices and sauteed diced onion and cilantro.
                  </p>
                </div>
                <div>
                  <div className="flex justify-between border-b border-[#d99e5f] pb-1">
                  ...
                  <p className="text-[#d99e5f] text-xs mt-1">
                  Boneless pieces of chicken breast delicately cooked in a creamy sauce with onion and exotic spices.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div>
              <div className="space-y-6">
                <div>
                  ...
                  <p className="text-[#d99e5f] text-xs mt-1">
                  Goat cooked in an onion & tomato sauce with authentic spices.
                  </p>
                </div>
                <div>
                  <div className="flex justify-between border-b border-[#d99e5f] pb-1">
                ...
                <div>
                  <div className="flex justify-between border-b border-[#d99e5f] pb-1">
                    <h3 className="font-semibold text-white">Palak Gosh (Lamb)</h3>
                    <span className="font-semibold text-white">$18.95</span>
                  </div>
                  <p className="text-[#d99e5f] text-xs mt-1">
                ...
                <div>
                  <div className="flex justify-between border-b border-[#d99e5f] pb-1">
                    <h3 className="font-semibold text-white">Lamb rogan josh</h3>
                    <span className="font-semibold text-white">$18.95</span>
                  </div>
                  <p className="text-[#d99e5f] text-xs mt-1">
          ...
          <div className="space-y-10">
            <div>
              <div className="space-y-6">
                <div>
                  <div className="flex justify-between border-b border-[#d99e5f] pb-1">
                    <h3 className="font-semibold text-white">lamb Coconut Curry</h3>
                    <span className="font-semibold text-white">$18.95</span>
                  </div>
                  <p className="text-[#d99e5f] text-xs mt-1">
                ...
                <div>
                  <div className="flex justify-between border-b border-[#d99e5f] pb-1">
                    <h3 className="font-semibold text-white">Lamb Shahi Korma</h3>
                    <span className="font-semibold text-white">$18.95</span>
                  </div>
                  <p className="text-[#d99e5f] text-xs mt-1">
                ...
                <div>
                  <div className="flex justify-between border-b border-[#d99e5f] pb-1">
                    <h3 className="font-semibold text-white">Lamb mango curry</h3>
                    <span className="font-semibold text-white">$17.95</span>
                  </div>
                  <p className="text-[#d99e5f] text-xs mt-1">
                ...
                <div>
                  <div className="flex justify-between border-b border-[#d99e5f] pb-1">
                    <h3 className="font-semibold text-white">Lamb madras curry</h3>
                    <span className="font-semibold text-white">$17.95</span>
                  </div>
                  <p className="text-[#d99e5f] text-xs mt-1">
                  Lamb Pieces Cooked in Onion, Tomato, Coconut Sauce and Spices. Tempered with mustard seeds.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="space-y-10">
            <div>
              <div className="space-y-6">
                ...
                <div>
                  <div className="flex justify-between border-b border-[#d99e5f] pb-1">
                    <h3 className="font-semibold text-white">Coconut prawn Curry</h3>
                    <span className="font-semibold text-white">$17.95</span>
                  </div>
                  <p className="text-[#d99e5f] text-xs mt-1">
                ...
                <div>
                  <div className="flex justify-between border-b border-[#d99e5f] pb-1">
                    <h3 className="font-semibold text-white">Traditional Prawn curry</h3>
                    <span className="font-semibold text-white">$17.95</span>
                  </div>
                  <p className="text-[#d99e5f] text-xs mt-1">
                ...
                <div>
                  <div className="flex justify-between border-b border-[#d99e5f] pb-1">
                    <h3 className="font-semibold text-white">Coconut Curry Fish</h3>
                    <span className="font-semibold text-white">$17.95</span>
                  </div>
                  <p className="text-[#d99e5f] text-xs mt-1">
                  Basa fish delicately cooked in coconut cream and royal spices.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="space-y-10">
            <div>
              <div className="space-y-6">
                <div>
                  <div className="flex justify-between border-b border-[#d99e5f] pb-1">
                    <h3 className="font-semibold text-white">Traditional Fish curry</h3>
                    <span className="font-semibold text-white">$17.95</span>
                  </div>
                  <p className="text-[#d99e5f] text-xs mt-1">
                  Prawns cooked in an onion & tomato sauce with ground spices.{" "}
                ...
                <div>
                  ...
                  <p className="text-[#d99e5f] text-xs mt-1">
                  Prawn prepared with bell peppers onion & exotic Indian spices with chilli garlic saus.
                  </p>
                </div>
              </div>
            </div>
      ...
      <section className="bg-[#110c09] text-white flex flex-col items-center px-4 py-10">
        <h1 className="text-4xl font-extrabold mb-3">Biryani Rice Specialties</h1>
        <div className="flex items-center gap-3 mb-14">
          <div className="border-t border-[#d99e5f] w-24"></div>
          <span className="text-[#d99e5f] text-2xl">
            <FontAwesomeIcon icon={faBowlFood} />
          ...
          <div className="space-y-10">
            <div>
              <div className="space-y-6">
                ...
                <div>
                  <div className="flex justify-between border-b border-[#d99e5f] pb-1">
                    <h3 className="font-semibold text-white">Chicken Biryani</h3>
                    <span className="font-semibold text-white">$17.95</span>
                  </div>
                  <p className="text-[#d99e5f] text-xs mt-1">
                    {/* Chicken breast coated in chickpea batter & deep fried. */}
      ...
      {/* -------------- Side Dishes ------------- */}
      <section className="bg-[#110c09] text-white min-h-screen flex flex-col items-center px-4 py-10">
        <h1 className="text-4xl font-extrabold mb-3">Appetizers</h1>
        <div className="flex items-center gap-3 mb-14">
          <div className="border-t border-[#d99e5f] w-24"></div>
          <span className="text-[#d99e5f] text-2xl">
